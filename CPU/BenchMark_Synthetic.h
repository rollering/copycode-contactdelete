...
#include "Multiple/Hyper.h"
#include "Common/MMap.h"
#include "Multiple/Single.h"
...
class BenchMark_Synthetic {
 ...
 private:
  ...
  void CompareSubset(T mp, T record) {
    ...
    std::cout<<"absolute error  "<<aae_sum<<std::endl;
    std::cout<<"average error  "<<are_sum<<std::endl;
#else
    double NUM = 0;
